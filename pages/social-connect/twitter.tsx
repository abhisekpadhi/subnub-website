    ...
    useEffect(() => {
        if (!(oauthVerifier && oauthToken)) {
            ...
            if (oauthToken.length > 0 && oauthVerifier.length > 0) {
                ...
                window.location.href = `subnub://social-connect?platform=twitter&oauth_token=${oauthToken}&oauth_verifier=${oauthVerifier}`;
            }
        }
                ...
                {state.done ? (
                    <>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                location.href = `subnub://social-connect?platform=twitter&oauth_token=${oauthToken}&oauth_verifier=${oauthVerifier}`;
                            }}
